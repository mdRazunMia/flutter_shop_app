...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts() async {
    const url =
        'https://fluttershopapp-38e8c-default-rtdb.firebaseio.com/products.json';
    try {
  ...
  Future<void> addProduct(Product product) async {
    ...
    try {
      //return http [we are using async so no need to use return]
      ...
      // it will convert the response which is an object to a map

      final newProduct = Product(
        id: json.decode(response.body)[
            'name'], // it will return the id that generated by firebase
        title: product.title,
        description: product.description,
        price: product.price,
        imageUrl: product.imageUrl,
